		...
		**/
        ...
        public function Calcular(){
			...
			$cURL = curl_init(sprintf(
				$this->url.'?nCdServico=%s,%s&nCdEmpresa=08082650&sDsSenha=564321&sCepOrigem=%s&sCepDestino=%s&nVlPeso=%s&nCdFormato=%s&nVlComprimento=%s&nVlAltura=%s&nVlLargura=%s&nVlDiametro=%s&sCdMaoPropria=%s&nVlValorDeclarado=%s&sCdAvisoRecebimento=%s&StrRetorno=%s',
				$this->servico,
				$this->servico2,
				$this->cepOrigem,
				$this->cepDestino,
