...
<html>
    <head>
        ...
        <link href="{$GET_TEMA}/images/logoicon.png" rel="shortcut icon" type="image/x-icon">
        <meta charset="UTF-8">
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="topo">
                ...
                <div class="container">
                    ...
                    <div class="col-md-6">
                         <img src="{$GET_TEMA}/images/logo-adm.png" alt="" style="width: 40%;"> 
                    </div>
            ...
            <div class="container"> 
               ...
               <h4 class="text-center text-danger" style="color: #5b5b5b;"> Olá Administrador <b>{$USER}</b>, seja bem vindo! O que deseja fazer agora?</h4> 
<section class="row">
